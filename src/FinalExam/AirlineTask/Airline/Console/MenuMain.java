...
public class MenuMain {
    ...
    public static void main(String[] args) {
        ...
        AirbusA220 airbusA220 = new AirbusA220("AirbusA220", 74, 35000,1800, 2.6,1);
        AirbusA320 airbusA320 = new AirbusA320("AirbusA320",86, 31000,1325, 3.2,2);
        AirbusA330 airbusA330 = new AirbusA330("AirbusA330",92, 31000, 1855, 3.5,3);
        Boeing717 boeing717 = new Boeing717("Boeing717",124, 49000, 2300, 5.6,4);
        Boeing737 boeing737 = new Boeing737("Boeing737",169, 56000, 1650, 6.1,5);
